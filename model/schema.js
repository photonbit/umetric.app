  ...
  tables: [
    tableSchema({
      ...
      columns: [
        ...
        { name: 'is_admin', type: 'boolean', isOptional: false },
        { name: 'sunday_week_start', type: 'boolean', isOptional: false },
      ],
    }),
    tableSchema({
      name: 'categories',
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'choices', type: 'number', isOptional: false },
        { name: 'slope', type: 'number', isOptional: false },
        { name: 'intercept', type: 'number', isOptional: false },
        { name: 'description', type: 'string', isOptional: true },
